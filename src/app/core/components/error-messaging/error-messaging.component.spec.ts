...
describe('ErrorMessagingComponent', () => {
  ...
  let errorMessagingServiceSpy: {
    ...
    getMessageProperty: jasmine.Spy;
  };
  ...
  describe('#ngOnInit', () => {
    it('should init', () => {
      component.ngOnInit();
      expect(
        errorMessagingServiceSpy.clearMessageProperty.calls.count()
      ).toBeGreaterThan(1);
    });
    ...
    it('should display error message', () => {
      ...
      errorMessagingServiceSpy.getMessageProperty.and.returnValue(
        errorMessageProperty
      );
      fixture.detectChanges();

      const htmlParagraphElement: HTMLParagraphElement =
